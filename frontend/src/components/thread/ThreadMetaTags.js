...
function MetaTag({ tag }) {
  ...
  const className =
    "relative z-10 flex shrink-0 cursor-pointer items-center gap-2 rounded-md border-[0.5px] border-[#CCCCCC] bg-[#E5E5E5] px-2 py-1 font-[family-name:var(--font-roboto)] text-[12px] font-normal leading-[16px] text-black transition-colors hover:bg-[#EBEBEB] lg:h-7 lg:gap-1.5 lg:border-0 lg:bg-[#F5F5F5] lg:py-0 lg:font-sans lg:font-bold lg:leading-none";
