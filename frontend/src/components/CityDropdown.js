          ...
          return (
            <li key={school.slug}>
              <Link
                ...
                className={`flex h-10 w-[268px] items-center gap-4 bg-white px-4 py-2 font-[family-name:var(--font-manrope)] text-[14px] font-normal leading-none tracking-normal text-black transition-colors duration-300 ease-out hover:!bg-[#CFE9ED] focus-visible:!bg-[#CFE9ED] ${
