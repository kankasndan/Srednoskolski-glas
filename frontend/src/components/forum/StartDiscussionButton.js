...
export default function StartDiscussionButton({ className = "" }) {
  ...
  return (
    <Link
      href="/new"
      className={`flex h-10 w-[268px] shrink-0 cursor-pointer items-center justify-center gap-3 rounded-xl bg-[#582FF5] px-4 py-2 font-[family-name:var(--font-manrope)] text-[14px] font-bold leading-none text-white transition-colors hover:bg-[#3300F5] ${className}`}
    >
