...
export default function StartDiscussionButton({ className = "", full = false }) {
  ...
  return (
    <Link
      href="/new"
      className={`flex size-10 shrink-0 cursor-pointer items-center justify-center rounded-xl border border-(--color-primary-200) bg-white transition-colors hover:bg-[#F5F5F5] lg:h-10 lg:w-[268px] lg:justify-center lg:gap-3 lg:border-0 lg:bg-[#582FF5] lg:px-4 lg:py-2 lg:text-white lg:hover:bg-[#3300F5] ${className}`}
    >
