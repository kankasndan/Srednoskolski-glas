...
const BASE_CLASS =
  "group flex h-10 cursor-pointer items-center overflow-hidden whitespace-nowrap rounded-xl border border-[var(--color-grays-300)] bg-white font-[family-name:var(--font-manrope)] text-[14px] font-normal leading-none text-[var(--color-grays-900)] transition-all duration-300 ease-in-out hover:bg-[#E5E5E5]";
