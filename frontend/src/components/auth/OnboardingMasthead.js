...
export default function OnboardingMasthead() {
  return (
    <div>
      ...
      <p className="mx-auto mt-12 max-w-[440px] text-center font-(family-name:--font-manrope) text-[20px] font-normal leading-[18.07px] tracking-[0%] text-[#000000] 2xl:max-w-[487px]">
