  ...
  return (
    <section className="flex h-32 w-[990px] max-w-full items-center gap-[122px] rounded-3xl bg-[#CFE9ED] py-6 pl-6 pr-[22px]">
      ...
      <Link
        href="/feed/create"
        prefetch={false}
        className="relative z-10 flex h-12 w-[268px] shrink-0 cursor-pointer items-center justify-center gap-3 rounded-2xl bg-[#582FF5] px-4 py-2 font-[family-name:var(--font-manrope)] text-[14px] font-bold leading-none text-white no-underline transition-colors hover:bg-[#4B25E0]"
      >
        <Image src="/plus.svg" alt="" width={24} height={24} className="pointer-events-none size-6" />
        <span className="pointer-events-none flex h-[19px] w-[168px] items-center leading-none">
