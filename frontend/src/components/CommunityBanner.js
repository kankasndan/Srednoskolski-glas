...
export default function CommunityBanner() {
  return (
    <section className="flex h-32 w-[990px] max-w-full items-center gap-[122px] rounded-3xl bg-[#CFE9ED] py-6 pl-6 pr-[22px]">
      ...
      <Link
        href="/new"
        className="flex h-12 w-[268px] shrink-0 cursor-pointer items-center justify-center gap-3 rounded-2xl bg-[#582FF5] px-4 py-2 font-[family-name:var(--font-manrope)] text-[14px] font-bold leading-none text-white transition-colors hover:bg-[#4B25E0]"
      >
