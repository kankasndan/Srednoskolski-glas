...
export const fieldClass =
  "h-14 w-full rounded-2xl border border-[#CCCCCC] px-4 py-2 font-(family-name:--font-manrope) text-[14px] font-normal leading-none focus:border-[#582FF5] focus:outline-none 2xl:h-14 2xl:px-5 2xl:text-[16px] mb-2";
