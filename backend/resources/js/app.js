...
const NAV_SECTIONS = [
    {
        title: "Почетна табла",
        items: [
            { key: "nav:dashboard", label: "Контролна табла", route: "/admin/dashboard" },
        ],
    },
    {
        title: "Модерација",
        items: [
            { key: "nav:reports", label: "Пријави", badge: 18, route: "/admin/reports" },
            { key: "nav:sanctions", label: "Санкции", route: "/admin/sanctions" },
            { key: "nav:appeals", label: "Жалби", badge: 3, route: "/admin/appeals" },
        ],
    },
    {
        title: "Заедница",
        items: [
            { key: "nav:users", label: "Корисници", route: "/admin/users" },
            { key: "nav:forums", label: "Форуми", route: "/admin/forums" },
        ],
    },
    {
        title: "Систем",
        items: [
            { key: "nav:roles", label: "Улоги и пермисии", route: "/admin/roles" },
        ],
    },
];
