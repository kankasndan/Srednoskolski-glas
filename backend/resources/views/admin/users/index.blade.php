            ...
            <script>
                ...
                function renderResults(users) {
                    ...
                    if (users.length === 0) {
                        ...
                        empty.textContent = 'Нема совпаѓања';
                        resultsBox.appendChild(empty);
                        resultsBox.classList.remove('hidden');
                        return;
                    }

                    // adminSearchRow writes usernames with textContent; building the
                    // row markup by hand would put an admin-visible XSS sink back.
                    users.forEach(user => {
