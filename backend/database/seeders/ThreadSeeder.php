...
class ThreadSeeder extends Seeder
{
    ...
    private const THREADS = [
        ...
        ['title' => 'Кои AI алатки ги користите за учење?', 'description' => 'Ме интересира кои вештачки интелигенции ви помагаат најмногу при подготовка на домашни и проекти.', 'forum' => 'Вештачка интелигенција', 'author' => 'demo@example.com', 'upvotes' => 76, 'views' => 1520, 'anonymous' => false, 'created_days_ago' => 1],
